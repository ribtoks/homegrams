...
{
    $plotter = new ContinuousPlotter(min($values) - 1, max($values) + 1, array($Func, $Median, $MedianSimple),
            "Weibull distribution with nju=$njuValue and sigma=$sigmaValue", 'white', $AvailableColors, 800, 600, 3);
